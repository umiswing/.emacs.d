(custom-set-variables
 ...
 '(package-selected-packages
   '(lua-mode multiple-cursors memory-usage counsel vscode-dark-plus-theme modus-themes beacon dot-mode evil lsp-pyright valign diff-hl elfeed orderless ef-themes rainbow-delimiters vertico consult find-file-in-project docker-tramp magit rime lsp-ui yasnippet helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode))
