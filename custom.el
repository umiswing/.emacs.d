(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-pyright valign diff-hl demap modus-themes elfeed orderless ef-themes blamer rainbow-delimiters vertico consult find-file-in-project docker-tramp magit rime lsp-ui yasnippet helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode))
